"""ORM models for GhostMind — SQLite compatible. (v2: measured metrics stored.)"""
import uuid
from datetime import datetime
from typing import Optional, List
from sqlalchemy import String, Text, Float, Integer, DateTime, JSON, ForeignKey, Index, func
...
class ResearchSession(Base):
    ...
    eval_breakdown: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    triplets: Mapped[List["EpisodicTriplet"]] = relationship("EpisodicTriplet", back_populates="session")
...
class EpisodicTriplet(Base):
    ...
    __table_args__ = (Index("ix_triplet_intent_strategy", "intent_hash", "strategy"),)
