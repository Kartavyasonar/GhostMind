...
class Settings(BaseSettings):
    ...
    # ── LLM API Keys ──────────────────────────────────────────────────────
    # Gemini: add up to 10 keys for maximum free-tier capacity
    GEMINI_API_KEY: str = ""
    ...
    # Legacy single-backend settings (still honoured if set)
    ...
    # ── Memory / MemRL ────────────────────────────────────────────────────
    MEMRL_ALPHA: float = 0.1
    MEMRL_GAMMA: float = 0.9
    MEMRL_EPSILON: float = 0.15
